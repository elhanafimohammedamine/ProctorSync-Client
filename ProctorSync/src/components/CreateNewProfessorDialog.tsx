...
import CreateNewProfessorForm from "@/components/CreateNewProfessorForm.tsx";
...
export default function CreateNewProfessorDialog() {
		...
		<DialogContent>
			<DialogHeader>
				<DialogTitle className="flex items-center gap-x-3">
					...
					Créer un nouvel enseignant</DialogTitle>
				<DialogDescription>
					This action cannot be undone. This will permanently delete your account
					and remove your data from our servers.
				</DialogDescription>
			</DialogHeader>
			<CreateNewProfessorForm onClose={closeDialog} />
		</DialogContent>
