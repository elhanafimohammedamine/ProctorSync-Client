...
import {newProfSchema, NewProfSchema} from "@/zod/schemas/new-prof-schema.ts";
...
export default function CreateNewProfessorForm() {


	const newProfForm = useForm<NewProfSchema>({
		resolver: zodResolver(newProfSchema),
	...
	const onSubmit = async (data: NewProfSchema) => {
