        ...
        <Card className="bg-transparent border-0 shadow-none">
            <CardHeader>
                <CardTitle className="flex gap-x-2 items-center">
                    <span className="text-2xl md:text-3xl">Salles d'Examen</span>
                </CardTitle>
                <CardDescription className="text-sm md:text-lg">Informations sur les salles d'éxamen</CardDescription>
            </CardHeader>
            <CardContent>
                <ul role="list" className="space-y-2">
                    {rooms.map((room, index) => (
                        <li key={room.id} className="flex justify-between items-center bg-card rounded-xl px-6 gap-x-6 py-3">
                            <div>
                                <div className="flex justify-center items-center min-w-0 gap-x-4">
                                    ...
                                    <div className="min-w-0 flex-auto">
                                        ...
                                        <p className="truncate text-xs leading-5 text-muted-foreground">Bloc
                                            : {room.bloc}</p>
                    ...
                    {rooms.length === 0 && (
                        <p className="text-sm py-10 text-muted-foreground italic text-center font-light">Aucune
                            salle</p>)}
                </ul>
            </CardContent>
        </Card>
