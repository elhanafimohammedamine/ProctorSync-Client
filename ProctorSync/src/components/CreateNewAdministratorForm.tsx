...
import { administratorSchema, AdministartorSchema } from "@/zod/schemas/administrator-schema";
...
export default function CreateNewAdministratorForm({ onClose } : Props) {


	const newAdminForm = useForm<AdministartorSchema>({
